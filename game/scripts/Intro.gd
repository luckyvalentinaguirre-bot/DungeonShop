extends Control
## Introducción tipo historia. Muestra la HOJA DE STORYBOARD completa en penumbra y va
## ILUMINANDO cada viñeta EN ORDEN mientras avanza la narración; el subtítulo aparece
## letra a letra. Se puede AVANZAR (click/tecla) o SALTAR (Esc). Al terminar entra a la
## tienda. Usa una sola imagen (assets/cinematic/storyboard.png), sin generar nada.

const SHEET := "res://assets/cinematic/storyboard.png"
const SHEET_SIZE := Vector2(1600, 872)
const SHOP := "res://game/scenes/Shop.tscn"
